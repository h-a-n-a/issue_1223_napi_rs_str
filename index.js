  ...
  case 'android':
    ...
    try {
      if (localFileExisted) {
        ...
        nativeBinding = require('issue_1223_napi_rs_str-android-arm64')
      }
    } catch (e) {
      loadError = e
    }
      ...
      case 'x64':
        ...
        try {
          if (localFileExisted) {
            ...
            nativeBinding = require('issue_1223_napi_rs_str-win32-x64-msvc')
          }
        } catch (e) {
          loadError = e
        }
      ...
      case 'ia32':
        ...
        try {
          if (localFileExisted) {
            ...
            nativeBinding = require('issue_1223_napi_rs_str-win32-ia32-msvc')
          }
        } catch (e) {
          loadError = e
        }
      ...
      case 'arm64':
        ...
        try {
          if (localFileExisted) {
            ...
            nativeBinding = require('issue_1223_napi_rs_str-win32-arm64-msvc')
          }
        } catch (e) {
          loadError = e
        }
      ...
      case 'x64':
        ...
        try {
          if (localFileExisted) {
            ...
            nativeBinding = require('issue_1223_napi_rs_str-darwin-x64')
          }
        } catch (e) {
          loadError = e
        }
      ...
      case 'arm64':
        ...
        try {
          if (localFileExisted) {
            ...
            nativeBinding = require('issue_1223_napi_rs_str-darwin-arm64')
          }
        } catch (e) {
          loadError = e
        }
  ...
  case 'freebsd':
    ...
    try {
      if (localFileExisted) {
        ...
        nativeBinding = require('issue_1223_napi_rs_str-freebsd-x64')
      }
    } catch (e) {
      loadError = e
    }
        ...
        if (isMusl) {
          ...
          try {
            if (localFileExisted) {
              ...
              nativeBinding = require('issue_1223_napi_rs_str-linux-x64-musl')
            }
          } catch (e) {
            loadError = e
          }
          ...
          try {
            if (localFileExisted) {
              ...
              nativeBinding = require('issue_1223_napi_rs_str-linux-x64-gnu')
            }
          } catch (e) {
            loadError = e
          }
        ...
        if (isMusl) {
          ...
          try {
            if (localFileExisted) {
              ...
              nativeBinding = require('issue_1223_napi_rs_str-linux-arm64-musl')
            }
          } catch (e) {
            loadError = e
          }
          ...
          try {
            if (localFileExisted) {
              ...
              nativeBinding = require('issue_1223_napi_rs_str-linux-arm64-gnu')
            }
          } catch (e) {
            loadError = e
          }
      ...
      case 'arm':
        ...
        try {
          if (localFileExisted) {
            ...
            nativeBinding = require('issue_1223_napi_rs_str-linux-arm-gnueabihf')
          }
        } catch (e) {
          loadError = e
        }
...
const { transform, transformWithString } = nativeBinding

module.exports.transform = transform
module.exports.transformWithString = transformWithString
